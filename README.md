...
### Part I
In the first part of the code the k-means algorithm is implemented and employed on a dataset od random points. This part illustrates how the centroids change in each iteration.
